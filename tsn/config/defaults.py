...
_C.MODEL.HEAD = CN()
_C.MODEL.HEAD.NAME = 'TRNHead'
_C.MODEL.HEAD.FEATURE_DIMS = 2048
_C.MODEL.HEAD.NUM_CLASSES = 51

_C.MODEL.HEAD.RELATION = CN()
_C.MODEL.HEAD.RELATION.NAME = 'TRNmultiscale'
_C.MODEL.HEAD.RELATION.IMG_FEATURE_DIMS = 256
